// tutorial03.cpp : Defines the entry point for the console application.
//
...
int main(int argc, char *argv[]) 
{
  ...
  // Open video file
  if(avformat_open_input(&pFormatCtx, "out.mp4", NULL, NULL)!=0)
  //if(avformat_open_input(&pFormatCtx, "test.flv", NULL, NULL)!=0)
