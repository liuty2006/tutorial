// tutorial05.cpp : Defines the entry point for the console application.
//
...
int audio_decode_frame(VideoState *is, double *pts_ptr) 
{
  ...
  for(;;) 
  {
    while(is->audio_pkt_size > 0) //at the begin: is->audio_pkt_size=0
    {
      int got_frame;
...
int stream_component_open(VideoState *is, int stream_index) 
{
  ...
  switch(codecCtx->codec_type) 
  {
    ...
    case AVMEDIA_TYPE_VIDEO:
      ...
      is->sws_ctx =
      sws_getContext(is->video_st->codec->width,is->video_st->codec->height,
